...
import com.google.api.codegen.discovery2.transformer.ruby.RubySampleTransformer;
...
public class MainDiscoveryProviderFactory implements DiscoveryProviderFactory {
  ...
  public static DiscoveryProvider defaultCreate(
    ...
    if (id.equals(RUBY)) {
      sampleTransformer = new RubySampleTransformer();
    }
  ...
  public DiscoveryProvider create(
    ...
    return defaultCreate(
        document, service, apiaryConfig, sampleConfigOverrides, override2, rubyNamesFile, id);
  }
}
